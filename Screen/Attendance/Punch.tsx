  ...
  return (
    ...
    >
      ...
      >
        ...
        <View
          style={[styles.overlayAccent, { backgroundColor: config.bgAccent }]}
        >
          {/* Phase label row */}
          <View style={styles.overlayPhaseRow}>
            <View
              style={[
                styles.overlayPhaseDot,
                { backgroundColor: config.animColor },
              ]}
            />
            <Text
              style={[styles.overlayPhaseLabel, { color: config.animColor }]}
            >
              {actionLabel}
            </Text>
          </View>
          ...
          {/* {LOTTIE[phase] ? (
            ...
            <ActivityIndicator size="large" color={config.animColor} />
          )} */}
          <LottieView
            source={LOTTIE[phase]}
            autoPlay
