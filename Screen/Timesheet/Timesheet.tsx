...
//       showAlert("success", "Success", editingTaskId ? "Task updated successfully!" : "Task added successfully!");
//       clearForm();
//       await onTasksUpdated();
//       await loadInitialData();
//     } finally {
...
//         <View style={styles.formContainer}>
//           <View style={styles.formHeader}>
//             <FontAwesome name="file-text-o" size={22} color="rgb(0, 41, 87)" />
//             <Text style={styles.sectionTitle}>
//               {editingTaskId ? "Edit Task" : "Add New Task"}
//             </Text>
//           </View>
...
//             <Text style={styles.label}>Task Title *</Text>
//             <View style={styles.inputContainer}>
//               <FontAwesome name="pencil" size={18} color="#6B7280" style={styles.inputIcon} />
//               <TextInput
//                 style={styles.textInput}
//                 placeholder="Enter task title"
//                 value={taskTitle}
...
//             <Text style={styles.label}>Task Description *</Text>
//             <View style={styles.inputContainer}>
//               <FontAwesome name="align-left" size={18} color="#6B7280" style={styles.inputIconTextArea} />
//               <TextInput
//                 style={[styles.textInput, styles.textArea]}
//                 placeholder="Enter task description"
//                 value={taskDescription}
...
//             {showCustomProject ? (
//               <View style={styles.inputContainer}>
//                 <FontAwesome name="tag" size={18} color="#6B7280" style={styles.inputIcon} />
//                 <TextInput
//                   style={styles.textInput}
//                   placeholder="Enter custom project name"
//                   value={customProject}
...
//           <View style={styles.switchContainer}>
//             <View style={styles.switchLabelContainer}>
//               <FontAwesome name="dollar" size={18} color="rgb(0, 41, 87)" />
//               <Text style={styles.switchLabel}>Billable</Text>
//             </View>
//             <Switch
//               value={isBillable}
...
//                 <Text style={styles.submitButtonText}>
//                   {saving
//                     ? (editingTaskId ? "Updating..." : "Submitting...")
...
//         <View style={styles.tasksContainer}>
//           <View style={styles.tasksHeader}>
//             <FontAwesome name="list-ul" size={20} color="rgb(0, 41, 87)" />
//             <Text style={styles.sectionTitle}>
//               Today's Tasks ({existingTasks.length})
//             </Text>
//           </View>
...
//                 style={styles.emptyStateCard}
//               >
//                 <FontAwesome name="calendar-times-o" size={48} color="rgba(0, 41, 87, 0.3)" />
...
//                     <View style={styles.taskFooter}>
//                       <View style={styles.taskDetail}>
//                         <FontAwesome name="briefcase" size={14} color="#6B7280" />
//                         <Text style={styles.taskDetailText}>{task.projectName || 'Unknown Project'}</Text>
//                       </View>
//                       <View style={styles.taskDetail}>
//                         <FontAwesome name="clock-o" size={14} color="#6B7280" />
//                         <Text style={styles.taskDetailText}>{formatMinutesToHoursAndMinutes(taskMinutes)}</Text>
//                       </View>
//                       <View style={styles.taskDetail}>
//                         <FontAwesome name="dollar" size={14} color={taskBillable ? '#10B981' : '#6B7280'} />
